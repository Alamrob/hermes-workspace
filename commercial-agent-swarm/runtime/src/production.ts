...
> = {
  commercial_runtime: [
    ...
    'control.get_a1_job_execution_permit(uuid,text,bigint)',
    ...
    'control.stage_dispatch_settlement(uuid,text,jsonb,text,bigint,text,text,bigint,bigint,integer)',
    'control.commit_dispatch_settlement(uuid,text,jsonb,text,bigint,text,text,bigint,bigint,integer,uuid)',
    'control.get_dispatch_settlement(uuid,text,jsonb,text,bigint,text,text,bigint,bigint,integer)',
